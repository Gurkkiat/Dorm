...
import { Plus, Users, ShieldCheck, Phone, Mail, UserPlus, Building2 } from 'lucide-react';
...
export default function ManageManagersPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Admin with no branch: fetch all managers
    ...
    const handleCreateManager = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert('Error creating manager: ' + err.message);
        } finally {
            setProcessing(false);
        }
    };
                            ...
                            <tbody className="text-sm divide-y divide-slate-50">
                                {managers.map((manager) => (
                                    <tr key={manager.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-2 text-indigo-600 font-bold text-xs uppercase bg-indigo-50 px-3 py-1 rounded-full w-fit">
                                                <ShieldCheck size={14} />
                                                Manager
                                            </div>
                                        </td>
                ...
                <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-6 overflow-y-auto">
                            <form id="manager-form" onSubmit={handleCreateManager} className="space-y-5">
                                ...
                                <div className="bg-indigo-50 text-indigo-800 p-3 rounded-xl border border-indigo-100 text-sm flex gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="opacity-80 mt-0.5">This manager will be automatically assigned to: <strong>{branch?.branches_name}</strong></p>
                                    </div>
                                </div>
